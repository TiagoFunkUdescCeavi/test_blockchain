...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O3', '-g', '-Wall', '-Werror', '-std=c++11', '-march=native', '-fstrict-overflow', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXFLAGS = ['-std=c++11', '-march=native', '-fstrict-overflow']
...
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_PACKET_H': '', 'HAVE_GETENV': '', 'HAVE_SYS_STAT_H': '', 'HAVE_SYS_IOCTL_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_INTTYPES_H': '', 'HAVE_RT': '', 'HAVE_SIGNAL_H': '', 'HAVE___UINT128_T': '', 'HAVE_IF_TUN_H': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_SYS_TYPES_H': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_UINT128_T': '', 'HAVE_STDLIB_H': '', 'HAVE_PTHREAD_H': '', 'INT64X64_USE_128': '', 'HAVE_DIRENT_H': '', 'HAVE_STDINT_H': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
EXAMPLE_DIRECTORIES = ['traffic-control', 'stats', 'udp', 'socket', 'ipv6', 'udp-client-server', 'tutorial', 'tcp', 'wireless', 'routing', 'realtime', 'error-model', 'matrix-topology', 'naming', 'energy']
EXEC_PREFIX = '/usr/local'
HAVE_MPI = 1
HTMLDIR = '/usr/local/share/doc/ns'
INCLUDEDIR = '/usr/local/include'
INCLUDES_MPI = ['/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi', '/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent', '/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include', '/usr/lib/x86_64-linux-gnu/openmpi/include']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_MPI = ['/usr//lib', '/usr/lib/x86_64-linux-gnu/openmpi/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
LIB_MPI = ['mpi_cxx', 'mpi']
LIB_RT = ['rt']
...
LINKFLAGS_MPI = ['-pthread', '-Wl,-rpath,/usr/lib/x86_64-linux-gnu/openmpi/lib']
...
NS3_EXECUTABLE_PATH = ['/home/tiago/Documentos/Trabalho REDES/pow/ns-allinone-3.25/ns-3.25/build/optimized/src/fd-net-device', '/home/tiago/Documentos/Trabalho REDES/pow/ns-allinone-3.25/ns-3.25/build/optimized/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/tiago/Documentos/Trabalho REDES/pow/ns-allinone-3.25/ns-3.25/build/optimized']
...
SHLIB_MARKER = '-Wl,-Bdynamic,--no-whole-archive'
SONAME_ST = '-Wl,-h,%s'
SQLITE_STATS = None
STLIBPATH_ST = '-L%s'
STLIB_MARKER = '-Wl,--whole-archive,-Bstatic'
STLIB_ST = '-l%s'
SUDO = ['/usr/bin/sudo']
...
cfg_files = ['/home/tiago/Documentos/Trabalho REDES/pow/ns-allinone-3.25/ns-3.25/build/optimized/ns3/config-store-config.h', '/home/tiago/Documentos/Trabalho REDES/pow/ns-allinone-3.25/ns-3.25/build/optimized/ns3/core-config.h']
cprogram_PATTERN = '%s'
